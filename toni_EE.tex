...
\begin{document}
	...
	\subsubsection{1. zsoltártónus} \gregorioscore[a]{dallam/tonus1_alap}
	\begin{multicols}{2}
		\subsubsection{1 re} \gregorioscore[a]{dallam/1D_term}
		\subsubsection{1 lá} \gregorioscore[a]{dallam/1g_term}
	\end{multicols}
	
	\subsubsection{2. zsoltártónus}
	\gregorioscore[a]{dallam/tonus2}
	
	\subsubsection{3. zsoltártónus} \gregorioscore[a]{dallam/tonus3}
	
	\subsubsection{4. zsoltártónus} \gregorioscore[a]{dallam/tonus4}
	...
	\subsubsection{7. zsoltártónus} \gregorioscore[a]{dallam/tonus7_alap}
	\begin{multicols}{2}
		\subsubsection{7 lá} \gregorioscore[a]{dallam/7a_term}
		\subsubsection{7 dó} \gregorioscore[a]{dallam/7c_term}
	\end{multicols}
	
	% Szintaktikai hiba javítva (hiányzó zárójel)
	\subsubsection{8. zsoltártónus} \gregorioscore[a]{dallam/tonus8_alap}
	\begin{multicols}{2}
		\subsubsection{8 szó} \gregorioscore[a]{dallam/8G_term}
		\subsubsection{8 dó} \gregorioscore[a]{dallam/8c_term}
	\end{multicols}
